...
1. Run $get-context.
2. After the brief is approved, route to $ideate.
3. Show exactly three visual options and wait for the user to choose one.
4. Do not scaffold, edit files, or start a server before a visual option is selected.
