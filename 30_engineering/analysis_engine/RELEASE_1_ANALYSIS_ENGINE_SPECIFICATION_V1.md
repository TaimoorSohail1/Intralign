...
**Authoritative inputs:** Planning Intelligence Spec · `RELEASE_1_DATA_MODEL_SPECIFICATION_V1.2.md` · `RELEASE_1_STATE_MODEL_SPECIFICATION_V1.md` · `RELEASE_1_EVENT_MODEL_SPECIFICATION_V1.md` · `RELEASE_1_API_CONTRACT_SPECIFICATION_V1.md` · `RELEASE_1_PERFORMANCE_AND_NFR_SPECIFICATION_V1.md` · `RELEASE_1_TESTING_STRATEGY_V1.md`
...
| 3 | **Claim Extraction** | hybrid | Extract the **bounded salient** claim subset (not exhaustive — fast horizon). Rule pre-filter (assertion patterns) bounds LLM load; LLM identifies claims incl. implicit; `dedup_key` for dedup/determinism 〔proposal〕. Target ≈ **50–100 claims** 〔proposal — `TBD`〕. Parallel chunks each carry the Stage-2 map. |
