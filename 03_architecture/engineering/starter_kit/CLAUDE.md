# CLAUDE.md — OSLO Application Repo (Claude Code instructions)

> **Where this goes:** the **root of the application repo** (`oslo`). **Claude Code reads this automatically** before touching code — it is the primary build-rules file for this team (which uses Claude Code). `AGENTS.md` (same content) is the tool-neutral twin for any other AGENTS.md-aware tool. **If this and an authoritative knowledge-base source differ, the source wins.**
