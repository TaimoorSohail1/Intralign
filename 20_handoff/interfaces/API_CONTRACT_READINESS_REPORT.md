...
**Inputs:** `RELEASE_1_API_CONTRACT_SPECIFICATION_V1.md` · `API_CONTRACT_ENDPOINT_CATALOG.md` · `RELEASE_1_DATA_MODEL_SPECIFICATION_V1.2.md` · `RELEASE_1_STATE_MODEL_SPECIFICATION_V1.md` · `RELEASE_1_EVENT_MODEL_SPECIFICATION_V1.md` · `OSLO_RELEASE_1_CANONICAL_SCOPE_V1.md`
