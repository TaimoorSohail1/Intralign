...
> The corpus already enforces "no invented numbers." This register **consolidates** the open items so an external team/LLM sees them in one place. The detailed, owner-assigned source of truth is **`10_product/acceptance/RELEASE_1_NFR_ACCEPTANCE_MATRIX.md`** (+ Performance/NFR §20). Where this register and that matrix differ, **the matrix wins.**
