...
3. Authorize an **engineering proposal** for provisional identity / persistence / claim-on-signup (Decision 2), and the DL-048 pre/post-signup gating (Decision 3) + retention/privacy (Decision 4). *(**Ratified 2026-06-19 — DL-080** (intent); packaged in `PROPOSAL_GA_DEFERRED_SIGNUP_ENGINEERING_REALIZATION_DRAFT.md`; reset-at-claim + 30-day unclaimed TTL settled; GA-gated, engineering authors the realization. Record: `00_owner/decisions/records/DL-080-ga-deferred-signup-realization.md`.)*
