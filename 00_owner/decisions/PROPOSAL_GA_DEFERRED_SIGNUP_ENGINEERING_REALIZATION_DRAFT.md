...
- **Status:** **Owner-ratified (intent) — DL-080 (2026-06-19).** All three parts adopted; the two open values decided — **reset-at-claim** (Part B) and a **30-day unclaimed TTL** (Part C) — and packaged as one decision. AI-drafted; owner ratified intent; **engineering authors the realization** (ratify ≠ author). **GA-gated** — Alpha/Beta runs authenticated and requires none of this; the realization must land **before GA open-access** (DL-073 §Phasing; DL-076 GA stage). Ratified record: `00_owner/decisions/records/DL-080-ga-deferred-signup-realization.md`.
