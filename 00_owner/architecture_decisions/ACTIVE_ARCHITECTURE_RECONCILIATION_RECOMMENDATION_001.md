...
| **State machines** (conflict escalation, communication authorization, runtime state) | `03_architecture/runtime_architecture/08_state_logic_state_machines.md` (**governed**) | **No** — the responsibility spec references states abstractly |
...
| **Confidence/integrity engineering logic** | `03_architecture/judgement_layer/09_confidence_integrity_logic.md` (**governed**) | **Partially** |
| **Governance override logic** | `03_architecture/governance_layer/11_governance_override_logic.md` (**governed**) | **No** (and it's Future scope anyway) |
