...
### CHG-162 — DL-128: Event is a notification, read-movement is a delta; one moment one toast

- **Date:** 2026-07-18 · **Authorizing Decision:** DL-128.
- **Affected Artifacts:** `00_owner/decisions/records/DL-128-notification-display.md` (new); `00_owner/decisions/decision_log.md` (records index regenerated).
...
### CHG-168 — DL-134: Confidence-panel footer declutter — one Why, trend-as-Timeline, no Steady

- **Date:** 2026-07-18 · **Authorizing Decision:** DL-134.
- **Affected Artifacts:** `00_owner/decisions/records/DL-134-confidence-footer-declutter.md` (new); `00_owner/decisions/decision_log.md` (records index regenerated).
...
### CHG-182 — DL-148: Execution-ready planning, Phase-2 · 2C — sequencing dependencies and the computed critical path

- **Date:** 2026-07-19 · **Authorizing Decision:** DL-148.
- **Affected Artifacts:** `00_owner/decisions/records/DL-148-execution-critical-path.md` (new); `00_owner/decisions/decision_log.md` (records index regenerated).
...
### CHG-188 — DL-154: The journey hero speaks the north star — stages become Understand, Optimize, Execute (amends DL-152)

- **Date:** 2026-07-20 · **Authorizing Decision:** DL-154.
- **Affected Artifacts:** `00_owner/decisions/records/DL-154-overview-hero-outcome-journey-amendment.md` (new); `00_owner/decisions/decision_log.md` (records index regenerated).
...
### CHG-192 — DL-238: A read that can execute the plan is not a read

- **Date:** 2026-08-23 · **Authorizing Decision:** DL-238.
- **Affected Artifacts:** `00_owner/decisions/records/DL-238-a-read-that-can-execute-the-plan-is-not-a-read.md` (new); `00_owner/decisions/decision_log.md` (records index regenerated).
