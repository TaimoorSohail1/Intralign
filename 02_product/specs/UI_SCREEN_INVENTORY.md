...
| **Recommendation Workspace** | Accept/reject/implement recommendations | Owner/member | `GET /projects/{pid}/recommendations`, `POST /recommendations/{rid}:accept|:reject|:implement` |
...
*Inventory reflects `RELEASE_1_UI_SPECIFICATION_V1.md` exactly. 13 primary screens + 4 embedded views; all map to API contract endpoints and v1.1 enums.*
