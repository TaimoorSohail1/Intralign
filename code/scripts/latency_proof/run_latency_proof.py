...
This script is engineering tooling (non-canonical, code/); it makes NO canonical change and writes
...
def _require_live_env() -> None:
    ...
    if missing:
        sys.exit(
            ...
            "See code/README.md (Local bring-up) and .env.example for the internal-Gemma base_url."
        )
