...
```bash
# 1) Supabase up (see code/README.md — use the ports `supabase status` PRINTS, DL-054):
supabase start
...
- The script writes nothing to the repo and makes no canonical change (engineering tooling, `code/`).
